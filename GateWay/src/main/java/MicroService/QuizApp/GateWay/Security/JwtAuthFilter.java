...
public class JwtAuthFilter implements Filter {
    ...
    public void doFilter(
         ...
         *
         * Browser sends OPTIONS before the actual POST/PUT/etc.
         * OPTIONS request does not contain Authorization header,
         * so JWT authentication must be skipped.
         */
        ...
        try {
            ...
            HttpServletRequest wrapped =
                    new HeaderAddingRequestWrapper(
                            request,
                            userId,
                            email,
                            userName
    ...
    /**
     * Adds X-User-Id / X-User-Email / X-User-Name
     * headers on top of the original request.
     *
     * HttpServletRequest headers are otherwise read-only,
     * so we use a wrapper.
     */
    private static class HeaderAddingRequestWrapper
        ...
        public Enumeration<String> getHeaders(String name) {
            ...
            if ("X-User-Id".equalsIgnoreCase(name)
                    ...
                    || "X-User-Name".equalsIgnoreCase(name)) {

                return java.util.Collections.enumeration(
                        List.of(getHeader(name))
                );
            }
