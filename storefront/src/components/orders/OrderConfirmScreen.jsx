  ...
  if (!order) {
    return (
      <div className="mx-auto max-w-xl px-4 py-16 text-center">
        ...
        <h1 className={`text-2xl font-black uppercase tracking-tighter ${t.text}`}>Order request sent</h1>
        <p className={`mt-2 text-sm ${t.muted}`}>
          Order processing started. Latest status ke liye orders page check karo.
        </p>
  ...
  return (
    <div className="mx-auto max-w-xl px-4 py-16">
      <div className="mb-8 text-center">
        ...
        <p className={`mb-1 font-mono text-xs uppercase tracking-widest ${t.faint}`}>Order #{order.id || order.orderId}</p>
